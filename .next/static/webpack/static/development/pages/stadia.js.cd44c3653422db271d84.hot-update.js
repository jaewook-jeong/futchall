...
/* harmony import */ var _reducers_location__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../reducers/location */ "./reducers/location.js");
/* harmony import */ var antd__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! antd */ "./node_modules/antd/es/index.js");
/* harmony import */ var _ant_design_icons__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ant-design/icons */ "./node_modules/@ant-design/icons/es/index.js");
/* harmony import */ var _SCSS_map_module_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../SCSS/map.module.scss */ "./SCSS/map.module.scss");
/* harmony import */ var _SCSS_map_module_scss__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_SCSS_map_module_scss__WEBPACK_IMPORTED_MODULE_6__);
var _this = undefined,
...
var Maps = function Maps(props) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    ...
    kakao.maps.event.addListener(temp, 'dragend', function () {
      ...
      dispatch({
        type: _reducers_location__WEBPACK_IMPORTED_MODULE_3__["REFRESH_STADIUMLIST_REQUEST"],
        data: {
    ...
    if (props.router.query.arr) {
      ...
      if (arr[0] === "success") {
        antd__WEBPACK_IMPORTED_MODULE_4__["message"].success(arr[1]);
      } else if (arr[0] === "warn") {
        antd__WEBPACK_IMPORTED_MODULE_4__["notification"].destroy();
        ...
        antd__WEBPACK_IMPORTED_MODULE_4__["message"].error(arr[1], 4);
      }
    }
  }, []);
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    stadiumList.forEach(function (c) {
      ...
      content.className = "".concat(_SCSS_map_module_scss__WEBPACK_IMPORTED_MODULE_6___default.a.mapOverLay);
      var content_inner = document.createElement('div');
      content_inner.className = "".concat(_SCSS_map_module_scss__WEBPACK_IMPORTED_MODULE_6___default.a.overLayInner);
      var content_title = document.createElement('div');
      content_title.className = "".concat(_SCSS_map_module_scss__WEBPACK_IMPORTED_MODULE_6___default.a.innerTitle);
      var btn_close = document.createElement('div');
      btn_close.className = "".concat(_SCSS_map_module_scss__WEBPACK_IMPORTED_MODULE_6___default.a.titleClose);
      ...
      content_body.className = "".concat(_SCSS_map_module_scss__WEBPACK_IMPORTED_MODULE_6___default.a.innerBody);
      var body_img = document.createElement('div');
      body_img.className = "".concat(_SCSS_map_module_scss__WEBPACK_IMPORTED_MODULE_6___default.a.bodyImg);
      ...
      body_info.className = "".concat(_SCSS_map_module_scss__WEBPACK_IMPORTED_MODULE_6___default.a.bodyInfo);
      var info_address = document.createElement('div');
      info_address.className = "".concat(_SCSS_map_module_scss__WEBPACK_IMPORTED_MODULE_6___default.a.bodyAddress);
  ...
  }, __jsx(_ant_design_icons__WEBPACK_IMPORTED_MODULE_5__["LoadingOutlined"], {
    style: {
      margin: '0 auto',
      width: '10vh',
      height: '10vh'
...
//# sourceMappingURL=stadia.js.cd44c3653422db271d84.hot-update.js.map