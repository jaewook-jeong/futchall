...
.ant-switch-small:not(.ant-switch-loading):active::before,
.ant-switch-small:not(.ant-switch-loading):active::after {
  width: 16px;
}
...
.ant-switch-small.ant-switch-checked:not(.ant-switch-disabled):active::after {
  left: 2px;
}
...
.ant-switch-checked:not(.ant-switch-disabled):active::after {
  left: 18px;
}
